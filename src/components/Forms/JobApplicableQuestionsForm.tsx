...
export const JobApplicableQuestionsForm = () => {
    ...
    return (
        <div>
            ...
            <p className="text-sm font-medium leading-6 text-muted-foreground py-3 mb-6 border-b-2">
                Do you want your candidates to answer certain questions before applying? If so, you can list them here. You can filter your
                candidates using the questions as well
            </p>
            <div>
                        ...
                        <div className="flex justify-between px-1 items-center mb-2">
                            ...
                            <Button
                                ...
                                onClick={() =>
                                    methods.setValue(
                                        "questions",
                                        methods.getValues("questions").filter((_: any, i: number) => i !== index)
                                    )
                                }
                            >
                                <X size={16} />
                ...
                <Button
                    ...
                    onClick={() =>
                        methods.setValue("questions", [
                            ...
                            { questionType: "Text Answer", question: "", options: [""] },
                        ])
                    }
                >
                    Add Question
